...
export default function Contact(){
    return(
        <Section id="contact" class="text-center !w-[50%] ml-[15rem] mr-auto">
            ...
            <div className="mt-8" >
                <div className="grid grid-cols-2 gap-4" >
                    ...
                    <InputBox placeholder="Enter your email" type="email" >Enter your Email</InputBox>
                </div>
                <InputBox placeholder="Enter your Subject" type="text" >Enter Subject</InputBox>
